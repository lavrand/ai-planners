...
(define (domain rcll-production-durative)
	...
	(:predicates
        ...
        (order-delivery-window-open ?ord - order)
  ...
  ; to properly handle additional bases:
	...
	(:durative-action fulfill-order-c0-within-tw
		:parameters (?ord - order ?wp - workpiece ?m - mps ?g - ds-gate
		             ?basecol - product-base-color ?capcol - product-cap-color)
                :duration (= ?duration 0.01)
		:condition (and  (at start (wp-at ?wp ?m INPUT)) (at start (wp-usable ?wp)) (over all (order-delivery-window-open ?ord))
	...
	(:durative-action fulfill-order-c1-within-tw
		:parameters (?ord - order ?wp - workpiece ?m - mps ?g - ds-gate
		             ?basecol - product-base-color ?capcol - product-cap-color
	...
	(:durative-action fulfill-order-c2-within-tw
		:parameters (?ord - order ?wp - workpiece ?m - mps ?g - ds-gate
		             ?basecol - product-base-color ?capcol - product-cap-color
	...
	(:durative-action fulfill-order-c3-within-tw
		:parameters (?ord - order ?wp - workpiece ?m - mps ?g - ds-gate
		             ?basecol - product-base-color ?capcol - product-cap-color
