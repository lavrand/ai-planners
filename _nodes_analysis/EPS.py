...
def calculate_log_etps_updated(nodes_expanded_file, time_file, solution_file):
    # Read the CSV files
    ...
    merged_df = pd.merge(merged_df, solution_df, on='Identifier')
...
solution_file = 'Solution.csv'  # Replace with your file path
log_etps = calculate_log_etps_updated(nodes_expanded_file, time_file, solution_file)
print(f"Log of Overall Average ETPS: {log_etps}")
