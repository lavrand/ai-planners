(define (problem rcll-production-090-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 99
    (order-fulfilled o3)  ; Announce 115
    (order-fulfilled o4)  ; Announce 552
    (order-fulfilled o5)  ; Announce 200
    (order-fulfilled o6)  ; Announce 215
