(define (problem rcll-production-060-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 203
    (order-fulfilled o3)  ; Announce 349
    (order-fulfilled o4)  ; Announce 572
    (order-fulfilled o5)  ; Announce 157
    (order-fulfilled o6)  ; Announce 97
