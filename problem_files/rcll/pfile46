(define (problem rcll-production-061-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 146
    (order-fulfilled o3)  ; Announce 202
    (order-fulfilled o4)  ; Announce 499
    (order-fulfilled o5)  ; Announce 220
    (order-fulfilled o6)  ; Announce 88
