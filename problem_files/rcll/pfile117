(define (problem rcll-production-004-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 100
    (order-fulfilled o3)  ; Announce 229
    (order-fulfilled o4)  ; Announce 574
    (order-fulfilled o5)  ; Announce 234
    (order-fulfilled o6)  ; Announce 82
