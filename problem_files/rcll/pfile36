(define (problem rcll-production-026-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 83
    (order-fulfilled o3)  ; Announce 420
    (order-fulfilled o4)  ; Announce 635
    (order-fulfilled o5)  ; Announce 201
    (order-fulfilled o6)  ; Announce 121
