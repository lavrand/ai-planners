(define (problem rcll-production-082-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 195
    (order-fulfilled o3)  ; Announce 197
    (order-fulfilled o4)  ; Announce 619
    (order-fulfilled o5)  ; Announce 127
    (order-fulfilled o6)  ; Announce 128
