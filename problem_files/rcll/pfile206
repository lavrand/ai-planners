(define (problem rcll-production-073-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 194
    (order-fulfilled o3)  ; Announce 357
    (order-fulfilled o4)  ; Announce 550
    (order-fulfilled o5)  ; Announce 232
    (order-fulfilled o6)  ; Announce 119
