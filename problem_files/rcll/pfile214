(define (problem rcll-production-006-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 131
    (order-fulfilled o3)  ; Announce 332
    (order-fulfilled o4)  ; Announce 607
    (order-fulfilled o5)  ; Announce 148
    (order-fulfilled o6)  ; Announce 132
