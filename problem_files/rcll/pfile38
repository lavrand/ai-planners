(define (problem rcll-production-037-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 114
    (order-fulfilled o3)  ; Announce 138
    (order-fulfilled o4)  ; Announce 546
    (order-fulfilled o5)  ; Announce 197
    (order-fulfilled o6)  ; Announce 52
