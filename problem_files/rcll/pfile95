(define (problem rcll-production-046-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 222
    (order-fulfilled o3)  ; Announce 352
    (order-fulfilled o4)  ; Announce 585
    (order-fulfilled o5)  ; Announce 193
    (order-fulfilled o6)  ; Announce 145
