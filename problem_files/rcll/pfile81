(define (problem rcll-production-019-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 65
    (order-fulfilled o3)  ; Announce 310
    (order-fulfilled o4)  ; Announce 510
    (order-fulfilled o5)  ; Announce 99
    (order-fulfilled o6)  ; Announce 196
