(define (problem rcll-production-081-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 123
    (order-fulfilled o3)  ; Announce 111
    (order-fulfilled o4)  ; Announce 596
    (order-fulfilled o5)  ; Announce 277
    (order-fulfilled o6)  ; Announce 73
