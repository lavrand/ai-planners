(define (problem rcll-production-062-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 91
    (order-fulfilled o3)  ; Announce 461
    (order-fulfilled o4)  ; Announce 556
    (order-fulfilled o5)  ; Announce 316
    (order-fulfilled o6)  ; Announce 192
