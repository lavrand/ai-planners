(define (problem rcll-production-040-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 8
    (order-fulfilled o3)  ; Announce 489
    (order-fulfilled o4)  ; Announce 599
    (order-fulfilled o5)  ; Announce 174
    (order-fulfilled o6)  ; Announce 86
