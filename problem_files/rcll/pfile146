(define (problem rcll-production-020-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 137
    (order-fulfilled o3)  ; Announce 387
    (order-fulfilled o4)  ; Announce 527
    (order-fulfilled o5)  ; Announce 140
    (order-fulfilled o6)  ; Announce 203
