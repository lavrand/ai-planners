(define (problem rcll-production-100-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 184
    (order-fulfilled o3)  ; Announce 178
    (order-fulfilled o4)  ; Announce 536
    (order-fulfilled o5)  ; Announce 262
    (order-fulfilled o6)  ; Announce 54
