(define (problem rcll-production-041-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 147
    (order-fulfilled o3)  ; Announce 457
    (order-fulfilled o4)  ; Announce 508
    (order-fulfilled o5)  ; Announce 237
    (order-fulfilled o6)  ; Announce 80
