(define (problem rcll-production-052-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 2
    (order-fulfilled o3)  ; Announce 261
    (order-fulfilled o4)  ; Announce 538
    (order-fulfilled o5)  ; Announce 141
    (order-fulfilled o6)  ; Announce 116
