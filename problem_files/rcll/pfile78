(define (problem rcll-production-084-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 79
    (order-fulfilled o3)  ; Announce 527
    (order-fulfilled o4)  ; Announce 534
    (order-fulfilled o5)  ; Announce 170
    (order-fulfilled o6)  ; Announce 15
