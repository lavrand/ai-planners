(define (problem rcll-production-023-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 167
    (order-fulfilled o3)  ; Announce 390
    (order-fulfilled o4)  ; Announce 685
    (order-fulfilled o5)  ; Announce 109
    (order-fulfilled o6)  ; Announce 107
