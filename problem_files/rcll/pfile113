(define (problem rcll-production-091-durative)
  ...
  (:goal (and
    ...
    (order-fulfilled o2)  ; Announce 152
    (order-fulfilled o3)  ; Announce 443
    (order-fulfilled o4)  ; Announce 567
    (order-fulfilled o5)  ; Announce 310
    (order-fulfilled o6)  ; Announce 216
